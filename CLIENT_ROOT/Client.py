...
class Client:
    ...
    def commit_(self, files, repo, message, current_time):
        pass
        ...
        while True:
            try:
                ...
                # pull
                    ...
                    current_files = list_files_in_tree(self.current_directory)
                    current_files_data = []
                    ...
                    if green or red:
                        ...
                        if input('do you want to commit changes? (enter 1 to commit) '.upper()) == '1':
                            ...
                            self.commit_(current_files, repo, 'THE COMMIT BEFORE PULLING', datetime.datetime.now())
                        else:
                    ...
                    current_files = os.listdir(self.current_directory)
                    self.commit_(current_files, repo, 'PULLED FROM SERVER', datetime.datetime.now())
                    print(Fore.WHITE)
